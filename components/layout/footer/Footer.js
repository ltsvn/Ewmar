                        ...
                        <div className="row">
                            <div className="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                                <div className="footer-widget__column footer-widget__about">
                                    ...
                                    <p className="footer-widget__about-text">Dostarczamy części. Instalujemy pewność. Zaufaj ekspertom – skontaktuj się z nami i zrealizuj swój projekt!</p>
                                </div>
                            </div>
                                    ...
                                    <ul className="footer-widget__contact-list list-unstyled">
                                        <li>
                                            ...
                                            <div className="content">
                                                <p><Link href="mailto:debra.holt@example.com">biuro@firmaewmar.pl</Link>
                                                </p>
                                            </div>
                                        </li>
                                        <li>
                                            ...
                                            <div className="content">
                                                <p>ul. Kazimierza Wielkiego 15, 37-530 Sieniawa</p>
                                            </div>
                                        </li>
                                        <li>
                                            <div className="icon">
