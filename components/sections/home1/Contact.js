                        ...
                        <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6">
                                <div className="contact-page__right">
                                    <h3 className="contact-page__title">Kontakt</h3>
                                    <ul className="contact-page__contact-list list-unstyled">
                                        ...
                                        <li>
                                            ...
                                            <div className="content">
                                                <h3>Email</h3>
                                                <p><Link href="mailto:biuro@firmaewmar.pl">biuro@firmaewmar.pl</Link></p>
                                            </div>
                                        </li>
                                    </ul>
                                    {/* Nowoczesna sekcja z godzinami otwarcia */}
                                    <div className="contact-page__hours">
                                        <div className="icon">
                                            <span className="icon-clock"></span> {/* Dodaj ikonę zegara */}
                                        </div>
                                        <div className="content">
